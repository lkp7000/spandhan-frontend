            ...
            <div className="flex justify-center">
                <div className="mr-4">
                    <button
                        ...
                        className="  py-3 px-9 mt-2 border flex align-middle justify-center text-center shadow-md-blue text-black-800 font-bold text-sm border-gray-100 rounded  focus:outline-none hover:shadow-slate-200 shadow-md text-[#0f4164]"
                    >
                        {selectedFacility}
                        <span className="ml-3">
                        ...
                        <ul className="absolute mt-2 bg-white shadow-md ">
                            {facilityDropdownItems.map((item, index) => (
                                <li
                                    ...
                                    className={`block px-4 py-2 mx-auto w-60 text-base hover:bg-gray-100 cursor-pointer dark:hover:bg-gray-200 hover:text-[#107dc7] dark:hover:text-white ${
                    ...
                    <div className="w-full flex justify-center my-8 mt-12">
                        <div className=" flex flex-col lg:w-fit w-fit lg:flex-row justify-center  mt-2 gap-1">
                            <div data-aos="fade-up" data-aos-duration="1000">
                                <div className=" group h-[3rem] flex cursor-pointer rounded-2xl bg-white  border border-gray-300 py-0 px-1 gap-1 hover:border-secondary hover:bg-slate-100 shadow-xl items-center">
                                    <div className="">
                                        <svg
                                            width="20"
                                            height="20"
